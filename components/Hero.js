...
function Hero() {
  return (
    <div className="bg-[url(/img/bg.svg)] w-full h-[calc(100vh-64px)] bg-right-bottom bg-no-repeat bg-[80vw_auto] 2xl:bg-auto">
      <div className="container px-5 lg:px-16 2xl:px-80 h-[calc(90vh-64px)] w-full flex flex-col justify-center items-start">
        ...
        <div className="cursor-pointer border border-[#891f5d] py-2 px-6 mt-5 text-[#891f5d] uppercase tracking-widest text-sm font-semibold hover:bg-[#891f5d] hover:text-white transition-all duration-300">
          <Link href="#services">
