...
function Service() {
  return (
    <div className="w-ful" id="services">
      ...
      {/* Main content */}
      <div className="bg-[#273036] text-gray-50 py-5 px-5 lg:px-16 2xl:px-80">
        <div className="flex flex-col md:flex-row justify-between items-start">
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="services w-full mt-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2lx:grid-cols-4 gap-5 ">
              <div className="w-full border border-gray-400 rounded-sm p-6">
                <h3 className="font-black mb-3 text-orange-600 text-lg uppercase">
                  Seo
                </h3>
                <p className="text-gray-400">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae
                  quidem error deleniti?
                </p>
              </div>
              <div className="w-full border border-gray-400 rounded-sm p-6">
                <h3 className="font-black mb-3 text-orange-600 text-lg">SMM</h3>
                <p className="text-gray-400">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae
                  quidem error deleniti?
                </p>
              ...
              <div className="w-full border border-gray-400 rounded-sm p-6">
                <h3 className="font-black mb-3 text-orange-600 text-lg">
                  LinkedIn Outreach
                </h3>
                <p className="text-gray-400">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae
              ...
              <div className="w-full border border-gray-400 rounded-sm p-6">
                <h3 className="font-black mb-3 text-orange-600 text-lg">
                  Marketing Blue Print and consultancy
                </h3>
                <p className="text-gray-400">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae
                  quidem error deleniti?
              ...
              <div className="w-full border border-gray-400 rounded-sm p-6">
                <h3 className="font-semibold mb-3 text-orange-600 text-lg">
                  Graphics Design
                </h3>
                <p className="text-gray-400">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae
